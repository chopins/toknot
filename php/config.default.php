...
/******************************************************************************
 *************** 不要修改本配置文件,请新建自定义配置文件******************************************  
 *************** 自定义配置文件位于__X_APP_DATA_DIR__目录下面的conf/config.php********************
 *************** __X_APP_DATA_DIR__常量在应用入口文件中定义，如果没有定义框架__init__.php会定义为var值******
 ******************************************************************************
 */
...
$_CFG->inotify->watch_list_conf = 'sync.conf';//位于__X_APP_DATA_DIR__/conf/目录下
$_CFG->inotify->log_file = 'sync'; //位于$_CFG->db_data目录下面
